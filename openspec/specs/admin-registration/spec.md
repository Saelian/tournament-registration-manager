...
Le système MUST identifier les inscriptions créées par un administrateur.
...
Le système MUST utiliser un User système pour les inscriptions admin sans compte utilisateur.
...
#### Scenario: Rattachement des inscriptions
- **WHEN** l'admin crée une inscription sans compte utilisateur associé
- **THEN** l'inscription est rattachée au User système

#### Scenario: Liste des inscriptions admin
- **WHEN** l'admin consulte les inscriptions du User système
- **THEN** il voit toutes les inscriptions créées par admin
