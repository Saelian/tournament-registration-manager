      ...
      <header className="border-b-4 border-foreground bg-card sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
          ...
          <div className="hidden lg:flex items-center gap-2 flex-wrap">
            ...
            {activeTournament && (
              <NavItem to={`/tournaments/${activeTournament.id}/tables`} label="Inscription" icon={PenLine} />
            )}
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56 font-bold">
                  ...
                  {isAuthenticated && user && (
                    <>
                      <DropdownMenuItem asChild>
                        <NavLink to="/profile" className="w-full cursor-pointer flex items-center gap-2">
