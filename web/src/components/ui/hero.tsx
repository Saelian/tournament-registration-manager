...
const Hero = forwardRef<HTMLDivElement, HeroProps>(
    ({ className, title, subtitle, description, cta, backgroundVariant = 'default', children, ...props }, ref) => {
        const bgClasses = {
            default: 'bg-card',
        ...
        return (
            <div ref={ref} className={cn('p-8 md:p-12 neo-brutal', bgClasses[backgroundVariant], className)} {...props}>
                {subtitle && (
                ...
                {description && (
                    <p
                        className={cn(
                            ...
                            backgroundVariant === 'primary' ? 'text-primary-foreground/90' : 'text-muted-foreground'
                        )}
                    >
                        {description}
                    </p>
