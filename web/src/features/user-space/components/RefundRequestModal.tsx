...
import { useRequestRefund, useRefundEligibility } from '../../payments/hooks'
...
export function RefundRequestModal({ open, onOpenChange, payment, registrations }: RefundRequestModalProps) {
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm mt-1">
                      Une fois le remboursement confirmé, toutes les inscriptions ci-dessus seront définitivement
                      annulées. Le remboursement sera effectué sur le moyen de paiement utilisé lors du paiement
                      initial.
                    </div>
                  </div>
                </div>
            ...
            <div className="p-4 bg-green-100 border-2 border-green-400 text-green-800">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm mt-1">
                    Votre demande de remboursement a été traitée. Le remboursement sera effectué sous quelques jours
                    ouvrés.
                  </div>
                </div>
              </div>
