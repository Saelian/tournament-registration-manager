...
import { useCreatePaymentIntent } from '../../payments/hooks'
      ...
      <div className="bg-card neo-brutal p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mb-4">{registration.table.tournament.name}</p>
      ...
      <Dialog open={cancelDialogOpen} onOpenChange={setCancelDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter className="gap-2">
            ...
            <Button onClick={handleConfirmCancel} disabled={cancelMutation.isPending} variant="destructive">
      ...
      <Dialog open={payDialogOpen} onOpenChange={setPayDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Vous allez être redirigé vers HelloAsso pour payer {formatPrice(registration.table.price)} € pour le
              tableau "{registration.table.name}".
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="gap-2">
