  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="py-4">
          {!previewData && <CsvDropzone onFileSelect={handleFileSelect} isLoading={previewMutation.isPending} />}
            ...
            <div className="space-y-4">
                ...
                <div className="flex gap-4 text-sm">
                  ...
                  {invalidCount > 0 && (
                    <span className="flex items-center gap-2">
                      ...
                      <span className="text-muted-foreground">erreur{invalidCount > 1 ? 's' : ''}</span>
                    </span>
                  )}
                </div>
              ...
              {invalidCount > 0 && (
                <p className="text-sm text-muted-foreground">
                  Seuls les tableaux valides seront importés. Cliquez sur une ligne pour voir les détails.
                </p>
              )}
            </div>
          )}
