        ...
        <div className={cn('max-w-7xl mx-auto p-6', cartPaddingBottom)}>
          ...
          {player && (
            <div className="animate-on-load animate-slide-up animation-delay-300 mb-6">
              <TableFilters showEligibleOnly={showEligibleOnly} onShowEligibleOnlyChange={setShowEligibleOnly} />
            </div>
          )}
            ...
            <div className="grid gap-4 animate-on-load animate-slide-up animation-delay-400">
              {filteredTables?.map((table) => {
                ...
                if (blockedByTimeConflict) blockedReason = 'Même horaire'
                  ...
                  blockedReason = 'Un maximum de deux tableaux par jour est autorisé (hors tableaux spéciaux)'
          ...
          {player && (
            <CartSummary
              ...
              waitlistTimerHours={tournament?.options?.waitlistTimerHours ?? 24}
            />
          )}
        </div>
      </div>
