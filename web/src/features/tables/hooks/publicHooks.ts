...
import { usePublicTables, useEligibleTables } from './dataHooks'
import { usePublicTournaments } from '../../tournament/hooks'
import type { Player } from '../../registrations/types'
...
export function useTableListLogic(tournamentId: string | undefined) {
    ...
    const tournament = tournaments?.find((t: Tournament) => t.id.toString() === tournamentId)
