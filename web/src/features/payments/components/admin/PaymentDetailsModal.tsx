    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Paiement effectué le {formatDateTime(payment.createdAt)}</DialogDescription>
        </DialogHeader>
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <div>
                  ...
                  <span className="font-medium">
                    {payment.refundMethod ? (REFUND_METHOD_LABELS[payment.refundMethod] ?? payment.refundMethod) : '-'}
                  </span>
                </div>
              </div>
            </div>
