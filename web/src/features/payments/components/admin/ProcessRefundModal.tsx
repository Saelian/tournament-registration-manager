    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>Confirmer le traitement du remboursement pour {subscriberName}</DialogDescription>
        </DialogHeader>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-orange-800">
                  En validant, vous confirmez que le remboursement a été effectué en amont (manuellement sur HelloAsso,
                  par virement, en espèces...).
                </p>
              </div>
            </div>
          </div>
