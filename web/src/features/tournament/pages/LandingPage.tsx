...
import { TablePlayersModal } from '../../registrations/components/public/TablePlayersModal'
import {
  MapPinIcon,
  CalendarIcon,
  Users,
...
export function LandingPage() {
  ...
  const globalSponsors = sponsors?.filter((s: PublicSponsor) => s.isGlobal) ?? []

  // Public registrations data
  const { data: publicRegistrations } = usePublicRegistrations()
    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-secondary border-2 border-dashed border-foreground p-12 text-center">
          ...
          <p className="text-muted-foreground">Il n'y a pas de tournoi actif pour le moment. Revenez plus tard !</p>
        </div>
      </div>
    )
  }
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="bg-card p-8 neo-brutal-lg w-64">
                      ...
                      <div className="text-center">
                        <div className="animate-count-up text-5xl font-black text-primary">{remainingPlaces}</div>
              ...
              <div className="max-w-7xl mx-auto px-6">
                <div className="animate-on-load animate-slide-up bg-accent p-6 neo-brutal">
                  ...
                  <div className="flex flex-wrap gap-4">
                    {globalSponsors.map((sponsor: PublicSponsor) => (
                      <div key={sponsor.id} className="bg-card p-4 neo-brutal-sm flex items-center gap-3">
                        <div>
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  {tournament.rulesLink && (
                    <a href={tournament.rulesLink} target="_blank" rel="noopener noreferrer">
                      <Button variant="outline" size="lg" className="bg-card relative z-10 neo-brutal">
