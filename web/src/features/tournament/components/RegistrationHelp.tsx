...
export function RegistrationHelp({ title = "Comment s'inscrire ?", steps, className }: RegistrationHelpProps) {
  return (
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm text-foreground/80 font-medium leading-snug">{step.description}</p>
              </div>
            )
          })}
        </div>
