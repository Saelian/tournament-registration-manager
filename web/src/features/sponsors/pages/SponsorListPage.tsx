    ...
    <div className="max-w-7xl mx-auto p-6 animate-on-load animate-slide-up">
      ...
      <div className="grid gap-4">
        {sponsors?.map((sponsor) => (
          <div key={sponsor.id} className="bg-card p-4 neo-brutal flex flex-col md:flex-row justify-between gap-4">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                ...
                {sponsor.contactEmail && (
                  <a href={`mailto:${sponsor.contactEmail}`} className="flex items-center gap-1 hover:text-foreground">
            ...
            <div className="flex md:flex-col justify-end gap-2">
              ...
              <Button className="bg-card text-foreground" size="sm" onClick={() => handleDelete(sponsor.id)}>
