...
import { Users, Euro, Percent, LayoutGrid, AlertTriangle, Calendar, ClipboardList, CreditCard } from 'lucide-react'
...
export function AdminDashboardPage() {
  ...
  const hasAlerts =
    stats.alerts.almostFullTables.length > 0 || stats.alerts.emptyTables.length > 0 || pendingRefunds > 0
        ...
        <Link to="/admin/tables" className="block">
          <Card className="h-full hover:bg-secondary/50 transition-colors cursor-pointer">
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">Ajouter, modifier ou supprimer des tableaux</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link to="/admin/tournament" className="block">
          <Card className="h-full hover:bg-secondary/50 transition-colors cursor-pointer">
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">Modifier les informations générales</p>
            </CardContent>
          </Card>
        </Link>
      </div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between p-3 bg-orange-100 border-2 border-orange-500">
                  <div>
                    ...
                    <p className="text-sm text-orange-800">Des utilisateurs ont demandé un remboursement</p>
                  </div>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-6">
                        <div className="text-right">
                          ...
                          <div className="text-sm text-muted-foreground">{fillRate.toFixed(0)}% rempli</div>
                        </div>
                        <div className="w-24 h-3 bg-secondary border border-foreground overflow-hidden">
                          <div
                            className={`h-full transition-all ${
                              fillRate >= 100 ? 'bg-destructive' : fillRate >= 80 ? 'bg-yellow-500' : 'bg-primary'
                            }`}
