      ...
      <Dialog open={promoteDialogOpen} onOpenChange={setPromoteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Êtes-vous sûr de vouloir promouvoir <strong>{registrationToPromote?.playerName}</strong> pour le tableau{' '}
              <strong>{registrationToPromote?.tableName}</strong> ?
              <br />
              <br />
              Un email sera envoyé au joueur pour l'informer qu'une place s'est libérée et qu'il doit procéder au
