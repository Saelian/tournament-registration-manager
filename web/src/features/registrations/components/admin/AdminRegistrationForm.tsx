                    ...
                    <div className="space-y-4 mt-4">
                        ...
                        {bypassRules && (
                            <div className="bg-amber-100 dark:bg-amber-900/30 border-2 border-amber-500 p-3 flex items-start gap-2 text-sm">
                                ...
                                <p>
                                    L'inscription sera créée même si le joueur dépasse la limite de 2 tableaux par jour
                                    ou si le tableau a atteint son quota maximum. Les règles de classement restent
                                    appliquées.
                                </p>
                            </div>
                        )}
