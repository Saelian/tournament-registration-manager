...
export function PlayerDetailsModal({ player, allRegistrations, open, onOpenChange }: PlayerDetailsModalProps) {
            ...
            <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-6 mt-4">
                    ...
                    <section className="space-y-2">
                        <h3 className="font-bold text-sm uppercase text-muted-foreground border-b pb-1">Joueur</h3>
                    ...
                    <section className="space-y-2">
                        ...
                        <div className="space-y-1 text-sm">
                            ...
                            <p className="flex items-center gap-2">
                                ...
                                <a href={`mailto:${player.subscriber.email}`} className="text-primary hover:underline">
                            ...
                            {player.subscriber.phone && (
                                <p className="flex items-center gap-2">
                                    ...
                                    <a href={`tel:${player.subscriber.phone}`} className="text-primary hover:underline">
                                        {player.subscriber.phone}
                                    </a>
                                </p>
                            )}
