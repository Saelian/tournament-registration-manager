        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto neo-brutal">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Informations complètes, historique des inscriptions et paiements.
                    </DialogDescription>
                </DialogHeader>
                            ...
                            .map((table) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <Badge
                                            variant={(STATUS_BADGE_VARIANTS[table.status] as BadgeVariant) ?? 'neutral'}
                                        >
                                            {statusInfo.label}
                                        </Badge>
                                    </div>
                        ...
                        <div className="text-sm bg-muted/10 p-2 rounded-sm border border-foreground/5">
                            {group.isAdminCreated ? (
                                ...
                                <>
                                    ...
                                    <p>
                                        <a
                                            href={`mailto:${group.subscriber.email}`}
                                            className="text-primary hover:underline break-all"
                                        >
                                    ...
                                    {group.subscriber.phone && (
                                        <p className="flex items-center gap-1 mt-1">
                                            ...
                                            <a
                                                href={`tel:${group.subscriber.phone}`}
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="text-sm bg-muted/10 p-2 rounded-sm border border-foreground/5">
                                <p className="text-xs text-muted-foreground mb-1">
                                    {formatDateTimeLong(group.payment.createdAt)}
                                </p>
