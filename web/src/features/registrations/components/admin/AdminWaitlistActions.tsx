            ...
            <div className="flex justify-between space-x-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Le tableau est complet ({confirmedCount}/{quota}). Une place doit se libérer (désistement ou
                  annulation) pour pouvoir promouvoir un joueur.
                </p>
              </div>
            </div>
          </HoverCardContent>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <br />
              <br />
              Le joueur recevra un email l'invitant à régler son inscription dans les délais impartis. S'il ne le fait
              pas, sa place sera remise en jeu.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
