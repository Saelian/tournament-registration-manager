    ...
    return (
        <div className="mt-6 pt-4 border-t-2 border-foreground/10">
            ...
            <div className="space-y-2">
                {waitlist.map((reg) => (
                    <div key={reg.id} className="flex items-center gap-4 p-3 bg-orange-50 border border-orange-200">
                                    ...
                                    <div className="flex justify-between space-x-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                Le tableau est complet ({confirmedCount}/{quota}). Une place doit se
                                                libérer (désistement ou annulation) pour pouvoir promouvoir un joueur.
                                            </p>
                                        </div>
                                    </div>
                                </HoverCardContent>
            ...
            <Dialog open={promoteDialogOpen} onOpenChange={setPromoteDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Êtes-vous sûr de vouloir promouvoir <strong>{selectedRegistration?.name}</strong> dans le
                            tableau <strong>{tableName}</strong> ?
                            <br />
                            <br />
