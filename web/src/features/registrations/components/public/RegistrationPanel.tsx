...
import { useUserAuth, LoginModal } from '../../../auth'
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Un simple email suffit, pas de mot de passe !</p>
              </div>
            </div>
  ...
  if (player) {
    return (
      <div className="bg-card p-4 neo-brutal">
        ...
        <p className="mt-3 text-sm text-primary font-medium">Sélectionnez les tableaux ci-dessous</p>
      </div>
    )
  }
