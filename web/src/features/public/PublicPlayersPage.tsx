        ...
        return (
            <div className="container mx-auto px-4 py-8">
                <div className="bg-destructive/10 border border-destructive p-4 rounded">
                    <p className="text-destructive">Une erreur est survenue lors du chargement des inscriptions.</p>
                </div>
            </div>
        )
    }
            ...
            <div className="mb-6 p-4 bg-primary/10 border-2 border-primary rounded-lg">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground">
                        joueur{(data?.totalPlayers || 0) !== 1 ? 's' : ''} inscrit{(data?.totalPlayers || 0) !== 1 ? 's' : ''}
                    </span>
                </div>
            </div>
